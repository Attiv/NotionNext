...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || 'd97f59c90fe84a58b8a000ce9719fc58',
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || 'GTM-TL48B2C', // Remove the value or replace it with your own google site verification code
